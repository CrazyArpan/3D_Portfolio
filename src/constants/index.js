  ...
  const projects = [
    {
      name: "PassOp",
      description:
        "Web-based platform that allows users to save edit delete copy passord site and username.It stores many site url username and password in a single place.",
      tags: [
        {
          name: "react",
