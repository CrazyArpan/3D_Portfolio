...
const projects = [
    {
        name: "PassOp",
        description:
            "Web-based platform that allows users to save, edit, delete, and copy passwords, site URLs, and usernames. It stores many site URLs, usernames, and passwords in a single place.",
        tags: [
            {
                name: "React",
